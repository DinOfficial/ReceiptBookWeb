        ...
        <div className="p-6">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div className="min-w-0">
              <h1 className="font-bold text-slate-800 leading-tight truncate">Receipt Book</h1>
        ...
        <div className="fixed inset-0 z-50 flex">
          ...
          <div className="relative w-64 bg-white h-full shadow-2xl flex flex-col">
            ...
            <nav className="p-4 space-y-1">
              ...
              <button 
                onClick={handleLogout}
                className="flex items-center gap-3 px-4 py-3 rounded-xl text-red-600 w-full"
              >
                <LogOut size={20} />
                <span className="font-medium">Logout</span>
              </button>
